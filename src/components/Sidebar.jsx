...
const Sidebar = ({ isOpen, setIsOpen, isAdmin }) => {
  ...
  const navItems = [
    ...
    { name: "Interviews", path: "/interviews", isAdmin: false },
    { name: "Reports", path: "/reports", isAdmin: false },
    { name: "Users", path: "/users", isAdmin: true },
    { name: "Settings", path: "/settings", isAdmin: false },
  ];
