      ...
      <div className="flex flex-col lg:flex-row w-full max-w-5xl shadow-2xl rounded-3xl overflow-hidden bg-white">
        ...
        <div className="lg:w-1/2 bg-indigo-600 text-white flex flex-col justify-between p-8">
          <div>
            ...
            <p className="text-lg font-light">a home for teamwork, where everyone comes together</p>
          </div>
          <p className="text-sm mt-auto">experiencing issues? <br /> get assistance via <a href="#" className="underline">support@nrt.com</a></p>
        </div>
        ...
        <div className="lg:w-1/2 w-full p-8 flex flex-col justify-center">
          <div className="mb-6 flex space-x-4 justify-center">
            <button
              className={`px-4 py-2 rounded-full ${isLogin ? "bg-indigo-500 text-white" : "bg-gray-100 text-gray-700"}`}
          ...
          <h2 className="text-2xl font-semibold text-center mb-2">{isLogin ? "Login" : "Register"}</h2>
