...
//   return (
//     <header className="bg-white shadow-sm  md:px-8 flex justify-between items-center rounded-b-lg z-10">
...
//             <img
//               src="https://placehold.co/40x40/E0E7FF/4F46E5?text=JD"
//               alt="User Avatar"
...
const Navbar = ({ toggleSidebar }) => {
  return (
    <header className="bg-white shadow-sm md:px-8 px-4 py-3 flex flex-wrap md:flex-nowrap justify-between items-center rounded-b-lg z-10">
        ...
        <div className="relative group">
          <button className="flex items-center space-x-2 focus:outline-none">
            <img
              ...
              className="w-10 h-10 rounded-full border-2 border-indigo-300"
            />
            <span className="hidden md:block text-gray-700 font-medium truncate max-w-[8rem]">
              John Doe
            </span>
            <svg
              className="w-4 h-4 text-gray-500"
